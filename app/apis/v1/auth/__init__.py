...
from app.apis.v1.auth.verifications import router as verifications_router
...
router.include_router(verifications_router, prefix="/verification", tags=["Verifications"])
