...
class UsagePerStoreLimitChecker(BaseLimitChecker):
    ...
    def check(
        ...
        """
        Check if usage per store limit is not exceeded.
        
        For USAGE_PER_STORE limit:
        - value: Maximum number of times the promotion can be used at a store
        - unit: ORDER
        """
        ...
        # TODO: Query promotion usage tracking table for this store
