...
class DeleteAssignedStoreOperation:

    def __init__(self, current_user: User, user_id: UUID, store_id: UUID):
    ...
    def execute(self, db: Session) -> None:
        ...
        store_member = (
            ...
            .filter(StoreMember.user_id == self.user_id, StoreMember.store_id == self.store_id)
            .first()
        )
